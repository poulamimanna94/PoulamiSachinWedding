...
function App() {
  ...
  const submitRsvp = async (e: FormEvent<HTMLFormElement>) => {
    ...
    window.open(`https://wa.me/919647000546?text=${encodeURIComponent(whatsappMessage)}`, '_blank', 'noopener,noreferrer')
          ...
          <div className="container rsvp-container">
            ...
            <div className="coordinator card animated-contact">
              ...
              <div className="contact-actions">
                <a href="tel:+919647000546" className="outline-btn"><i className="fas fa-phone" /> Call</a>
                <a href="https://wa.me/919647000546?text=Hello%20Poulami%2C%20this%20is%20regarding%20your%20wedding" target="_blank" rel="noreferrer" className="whatsapp-btn"><i className="fab fa-whatsapp" /> WhatsApp</a>
              </div>
            </div>
